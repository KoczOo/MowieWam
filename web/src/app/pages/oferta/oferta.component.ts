...
export class OfertaComponent {
      ...
      services: [
        {
          ...
          short: 'Pierwszy krok do skutecznej terapii.',
          highlight: true,
          paragraphs: [
          ...
          includes: [
            ...
            'Badanie funkcjonowania aparatu mowy',
            'Analiza mowy spontanicznej dziecka',
            'Standaryzowane testy diagnostyczne',
            'Pisemna opinia z planem terapii'
          ],
        ...
        },
        {
          ...
          short: 'Praca nad poprawną artykulacją głosek.',
          paragraphs: [
          ...
          helpsWhen: [
            'Sepleni (ś, ź, ć, dź zamiast s, z, c, dz lub sz, ż, cz, dż)',
            'Reranie – brak głoski [r] lub [r] gardłowe',
            'Mowa bezdźwięczna lub zniekształcona',
            'Mowa niewyraźna mimo wieku ≥ 4 r.ż.'
          ],
          meta: {duration: '45 min', for: 'dzieci i dorośli'}
        },
        {
          icon: 'child_care',
          title: 'Terapia opóźnionego rozwoju mowy (ORM)',
          short: 'Wsparcie dla maluchów, które „nie chcą” jeszcze mówić.',
          paragraphs: [
          ...
          helpsWhen: [
            'Maluch nie mówi pierwszych słów po 18 m-cu życia',
            'Słownik aktywny poniżej 50 słów po 2 r.ż.',
            'Brak prostych zdań dwuwyrazowych po 2,5 r.ż.',
            'Mowa niezrozumiała dla otoczenia po 3 r.ż.'
          ],
        ...
        },
        {
          ...
          short: 'Spektrum autyzmu, afazja, dziecięca apraksja mowy.',
          paragraphs: [
          ...
          helpsWhen: [
            'Diagnoza spektrum autyzmu lub Aspergera',
            'Afazja rozwojowa lub po przebytym udarze',
            'Dziecięca apraksja mowy (CAS)',
      ...
      services: [
        {
          ...
          short: 'Język na właściwym miejscu, prawidłowy oddech, harmonijny zgryz.',
          paragraphs: [
        ...
        },
        {
          ...
          title: 'Wczesna interwencja logopedyczna',
          short: 'Opieka nad noworodkiem i niemowlęciem.',
          paragraphs: [
          ...
          helpsWhen: [
            ...
            'Częste ulewania, niepokój przy jedzeniu',
            'Podejrzenie skróconego wędzidełka',
        ...
        },
        {
          ...
          short: 'Precyzja, koordynacja, grafomotoryka – I i II stopień.',
          paragraphs: [
          ...
          helpsWhen: [
            ...
            'Unika aktywności plastycznych',
            'Zbyt mocno lub zbyt delikatnie naciska kredką',
            'Obniżona sprawność grafomotoryczna',
            'Zamiennie posługuje się prawą i lewą ręką'
          ],
          meta: {duration: '45 min', for: 'dzieci od 3 r.ż.'}
        },
        {
          icon: 'menu_book',
          title: 'Nauka czytania metodą sylabową',
          short: 'Symultaniczno-sekwencyjna metoda – nauka, która naprawdę działa.',
          paragraphs: [
          ...
          helpsWhen: [
            'Dziecko od 3 r.ż. wykazujące zainteresowanie literami',
            'Wsparcie nauki w klasach 1–3',
            'Trudności z syntezą i analizą sylabową',
        ...
        {
          icon: 'restaurant',
          title: 'Terapia wybiórczości pokarmowej',
          short: 'Wsparcie dla małych „niejadków”.',
          paragraphs: [
          ...
          helpsWhen: [
            'Dziecko je tylko kilka wybranych produktów',
            'Niechęć do nowych konsystencji lub smaków',
            'Krztuszenie się przy jedzeniu',
            'Stres w trakcie posiłków – własny lub rodzica'
          ],
          meta: {duration: '45 min', for: 'dzieci od 1 r.ż.'}
        },
        {
          icon: 'hearing',
          title: 'Terapia funkcji słuchowych',
          short: 'Słyszę – ale czy odbieram? Trening percepcji słuchowej.',
          paragraphs: [
          ...
          helpsWhen: [
            'Dziecko nie reaguje na polecenia mimo dobrego słuchu',
            'Trudności z rozumieniem złożonych wypowiedzi',
            'Słaba koncentracja i pamięć słuchowa',
      ...
      services: [
        {
          icon: 'music_note',
          title: 'Logorytmika',
          short: 'Muzyka, ruch i mowa w jednej przygodzie.',
          paragraphs: [
        ...
        },
        {
          icon: 'palette',
          title: 'Sensoplastyka®',
          short: 'Stymulacja zmysłów przez sztukę.',
          paragraphs: [
          ...
          includes: [
            'Bezpieczne, jadalne barwniki i masy',
            'Pełna swoboda twórcza dziecka',
            'Praca w małej grupie',
            'Dyplom uczestnika po cyklu'
          ],
        ...
        },
        {
          ...
          short: 'Komunikacja, emocje i relacje rówieśnicze.',
          paragraphs: [
          ...
          helpsWhen: [
            'Dziecko ma trudności z nawiązywaniem kontaktów',
            'Spektrum autyzmu / Asperger',
            'Wybuchy emocji, trudność z ich rozpoznaniem',
            'Nieśmiałość uniemożliwiająca funkcjonowanie w grupie'
          ],
  ...
  faqs = [
    {
      q: 'Od jakiego wieku mogę przyprowadzić dziecko?',
      a: 'Pracujemy z dziećmi w każdym wieku. Już u kilkumiesięcznego niemowlaka warto obserwować rozwój komunikacji – zachęcamy do konsultacji wczesnej interwencji nawet od 6. miesiąca życia.'
    },
    {
      q: 'Skąd wiem, że moje dziecko potrzebuje logopedy?',
      a: 'Jeśli masz wątpliwości – zadzwoń. Czasem jedna konsultacja wystarczy, by uspokoić rodzica. Najczęstsze sygnały to: brak gaworzenia, opóźniony rozwój mowy, problemy z artykulacją po 4 r.ż., problemy z jedzeniem czy oddychanie przez usta.'
    },
    {
      q: 'Ile trwa terapia?',
      a: 'To zawsze indywidualna sprawa. Niektóre wady wymowy można wypracować w kilka miesięcy, inne wymagają systematycznej, dłuższej pracy. Wszystko omawiamy podczas diagnozy.'
    },
    {
      q: 'Czy rodzic uczestniczy w zajęciach?',
      a: 'W przypadku małych dzieci – często tak. U starszych dziecko zostaje z terapeutą w gabinecie, a rodzic na koniec zajęć dostaje krótkie podsumowanie i wskazówki do pracy w domu.'
    },
    {
      q: 'Czy zajęcia są refundowane przez NFZ?',
      a: 'Mówię Wam to placówka prywatna – nie pracujemy w ramach NFZ. Wystawiamy faktury, które można wykorzystać przy ulgach podatkowych lub ubezpieczeniach prywatnych.'
    },
    {
      q: 'Czy pracujecie również z dorosłymi?',
      a: 'Tak. Prowadzimy terapię wad wymowy oraz terapię miofunkcjonalną u dorosłych. Wspieramy także leczenie ortodontyczne oraz pacjentów po przebytych udarach (afazja).'
    }
  ];
